  ...
  return (
    <div className="parent py-24 mt-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        ...
        >
          <h2 className="text-2xl font-medium mt-5">Contact Me</h2>
        ...
        <motion.div
          ...
          variants={contactAnimation}
        >
          <h2 className="text-2xl font-medium ml-10 mt-5">Contact Info</h2>
          ...
          <div className="mt-8 flex items-center ml-12">
            ...
            <a
              href="https://www.linkedin.com/in/shivshant-prasad21351126198/"
              target="blank"
            ...
            <a
              href="https://github.com/Shivshantp21"
              target="blank"
              className="text-3xl text-neutral hover:text-primary hover:-translate-y-1.5 shadow-lg mx-1 duration-300"
            >
